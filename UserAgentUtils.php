...
class UserAgentUtils
{
	...
	public static function isMobileBrowser($ua)
    {
		...
		if(UserAgentMatcher::contains($lowerua, TeraWurfl\WurflConstants::$MOBILE_BROWSERS)) return true;
	...
	public static function isDesktopBrowser($ua)
    {
		...
		foreach (TeraWurfl\WurflConstants::$DESKTOP_BROWSERS as $signature) {
