...
abstract class Handler implements Filter, Matcher
{
     ...
     * @var \Wurfl\Handlers_Handler
     */
    private $nextHandler;
    
    /**
     * @var \Wurfl\Request_UserAgentNormalizer
     */
     ...
     * @param \Wurfl\Request_UserAgentNormalizer_Interface $userAgentNormalizer
     */
     ...
     *
     * @param \Wurfl\Handlers_UserAgentHandler $handler
     */
     ...
     * 
     * @see $userAgentNormalizer, \Wurfl\Request_UserAgentNormalizer
     * @param string $userAgent
    ...
    public function applyRecoveryCatchAllMatch($userAgent)
    {
        ...
        if ($mobile) return Constants::GENERIC_MOBILE;
