...
class WURFL_WURFLUtils {
     ...
     * @return string
     */
    public static public function getUserAgent($request) {            
     ...
     */
    public static public function getUserAgentProfile($request) {
     ...
     * @return bool
     */
    public static public function isXhtmlRequester($request) {
