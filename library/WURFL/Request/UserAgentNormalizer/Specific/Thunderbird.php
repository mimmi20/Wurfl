 ...
 * @package    WURFL_Request_UserAgentNormalizer_Specific
 */
class WURFL_Request_UserAgentNormalizer_Specific_Thunderbird implements WURFL_Request_UserAgentNormalizer_Interface {
	...
	private function firefoxWithMajorAndMinorVersion($userAgent) {
		return substr ( $userAgent, strpos ( $userAgent, "Thunderbird" ), 15 );
	}
