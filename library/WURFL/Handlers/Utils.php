...
class Utils
{
    ...
    /** 
     * Alias of \WURFL\Handlers\Matcher_RISMatcher::match()
    ...
    /**
     * Alias of \WURFL\Handlers\Matcher_LDMatcher::match()
     * @param array $collection
     * @param string $needle
     * @param int $tolerance
     * @return string Matched user agent
    ...
    public static function isDesktopBrowserHeavyDutyAnalysis($userAgent)
    {
        ...
        // Chrome
        if (Utils::checkIfContains($userAgent, 'Chrome') && !Utils::checkIfContains($userAgent, 'Ventana')) return true;
