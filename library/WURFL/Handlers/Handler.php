...
/**
 * \WURFL\Handlers\Handler is the base class that combines the classification of
...
abstract class Handler implements Filter, Matcher {
     ...
     * @param \WURFL\Request\UserAgentNormalizer\NormalizerInterface $userAgentNormalizer
     */
    public function __construct($wurflContext, $userAgentNormalizer = null) {
        
        if (is_null($userAgentNormalizer)) {
            $this->userAgentNormalizer = new \WURFL\Request\UserAgentNormalizer_Null();
        } else {
     ...
     *
     * @param \WURFL\Handlers\UserAgentHandler $handler
     */
