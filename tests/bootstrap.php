 ...
 * @version   SVN: $Id: bootstrap.php 250 2012-03-24 11:43:08Z tmu $
 * @link      todo
 */
...
$autoLoader->registerNamespace('WURFL');
...
require_once LIB_PATH . DS . 'AppCore' . DS . 'Model' . DS . 'ModelAbstract.php';
require_once LIB_PATH . DS . 'AppCore' . DS . 'Model' . DS . 'Cache' . DS . 'ModelCache.php';
require_once LIB_PATH . DS . 'AppCore' . DS . 'Service' . DS . 'ServiceAbstract.php';
require_once LIB_PATH . DS . 'AppCore' . DS . 'View' . DS . 'Helper' . DS . 'GetFileAbstract.php';