...
class Wurfl_Configuration_InMemoryConfigTest extends PHPUnit_Framework_TestCase {
	...
	public function testShouldCreateFilePersistence() {
		...
		$config->wurflFile ( "./wurfl.xml" )
			...
			->cache ( "file", array (\Wurfl\Configuration\Config::DIR => "./cache", \Wurfl\Configuration\Config::EXPIRATION=>3600 ) );
	...
	public function testShouldCreateConfiguration() {
		...
		$this->assertEquals ( array (\Wurfl\Configuration\Config::DIR => "./cache", \Wurfl\Configuration\Config::EXPIRATION=>3600 ), $cache ["params"] );
