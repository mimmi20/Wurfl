...
class WURFL_Request_UserAgentNormalizerTest extends PHPUnit_Framework_TestCase {
	...
	function testShouldAddANormalizer() {
		...
		$currentNormalizer = $userAgentNormalizer->addUserAgentNormalizer(new \Wurfl\Request\UserAgentNormalizer\Specific\Chrome());
	...
	function testShouldAddToAlreadyPresentNormalizers() {
		...
		$userAgentNormalizer = $userAgentNormalizer->addUserAgentNormalizer(new \Wurfl\Request\UserAgentNormalizer\Specific\Chrome());
