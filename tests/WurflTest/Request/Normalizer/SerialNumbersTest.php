...
class SerialNumbersTest extends BaseTest
{
    ...
    public function serialNumbersDataProvider()
    {
        return array(
            ...
            array(
                'MOT-V176/6.6.61[ST010913001046723002023302085980278] UP.Browser/6.2.3.9.c.9 (GUI) MMP/2.0 '
                . 'UP.Link/6.3.0.0.0',
                'MOT-V176/6.6.61 UP.Browser/6.2.3.9.c.9 (GUI) MMP/2.0 UP.Link/6.3.0.0.0'
            ),
            array('Mozilla', 'Mozilla'),
            array(
                'Vodafone/1.0/V702NK/NKJ001/IMEI/SN354350000005026 Series60/2.6 Nokia6630/2.40.235 Profile/MIDP-2.0 '
